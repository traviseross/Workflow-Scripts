...
dt_find = f'find /Users/{USERNAME}/{DT3_PATH} /Users/{USERNAME}/Library/Application\ Support/DEVONthink\ 3 -type f -name "* - * [0-9]*" \( -iname \*.pdf -o -iname \*.docx -o -iname \*.doc -o -iname \*.xlsx -o -iname \*.xls -o -iname \*.md -o -iname \*.ppt -o -iname \*.pptx -o -iname \*.epub \)'
...
for link in broken_links:
    ...
    if link_file in dt_files_names:
        ...
        dt_home = dt_home.translate(dict)
        os.system(f'ln -snf "{dt_home}" /Users/{USERNAME}/{ZOTERO_FOLDER}')
    else:
...
for file in dt_files_names:
    ...
    if file in zot_files_names:
        ...
        dt_home = dt_home.translate(dict)
        os.system(f'ln -snf "{dt_home}" /Users/travisross/ZotFile\ Import')
